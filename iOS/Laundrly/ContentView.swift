...
struct ContentView: View {
    @EnvironmentObject var store: LaundrlyStore
    @EnvironmentObject var purchases: PurchaseManager

    @State private var showingAdd = false
    @State private var showingSettings = false
    @State private var showingPaywall = false
    @State private var editingEntry: LaundrlyEntry?
    ...
    private func entryRow(_ entry: LaundrlyEntry) -> some View {
        HStack {
...
struct AddEntrySheet: View {
    ...
    init(existing: LaundrlyEntry? = nil, onSave: @escaping (String, Double) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existing == nil ? "Add Visit" : "Edit Visit")
